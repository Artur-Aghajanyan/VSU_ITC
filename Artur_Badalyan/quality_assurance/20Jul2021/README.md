...
##After installation, we will put the result folder in the apache-jmeter-5.4.1 folder
...
Into apache-jmeter-5.4.1/bin write 

JMeterPluginsCMD.sh --generate-png ../result/test.png --input-jtl ../result/result.jtl --plugin-type ResponseTimesOverTime --width 800 --height 600
